package ru.ifmo.rgl.server;

import io.grpc.Server;
import io.grpc.ServerBuilder;
import io.grpc.stub.StreamObserver;
import ru.ifmo.rgl.gameobjects.GameObject;
import ru.ifmo.rgl.gameobjects.characters.player.Confusion;
    ...
    private static class NetworkRGLService extends NetworkRGLGrpc.NetworkRGLImplBase {
        ...
        public void getServerList(Empty request, StreamObserver<ServerList> responseObserver) {
            ...
            for (String name : sessions.keySet()) {
                builder.addServers(ru.ifmo.rgl.proto.Server.newBuilder().setName(name).build());
            }
         ...
         */
        @Override
        public void createServer(ru.ifmo.rgl.proto.Server request, StreamObserver<EnterServerResponse> responseObserver) {
            ServerGameLoop loop;
         ...
         */
        @Override
        public void enterServer(ru.ifmo.rgl.proto.Server request, StreamObserver<EnterServerResponse> responseObserver) {
